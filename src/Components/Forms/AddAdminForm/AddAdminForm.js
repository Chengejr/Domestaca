...
const AddAdminForm = () => {
  ...
  const submitAdminForm = (e) => {
    ...
    axios
      ...
      .then((res) => {
        setDone(true); // Show DoneModal on success
      })
      .catch((error) => {
  ...
  return (
    <div className="dark:bg-gray-500">
      {done && <DoneModal />} {/* Conditional rendering for DoneModal */}
          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-5">
              ...
              <p className="mt-4 text-sm text-gray-600 dark:text-gray-200 text-center">
                Add an admin to manage this website's data and users. To login
                as an admin, you must log out from the previous account and input
                the email and password in the login form. It will detect the
                admin automatically and allow login.
              </p>
            </div>
          </div>
