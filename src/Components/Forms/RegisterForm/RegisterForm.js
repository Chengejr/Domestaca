import { IdentificationIcon, KeyIcon, MailIcon } from "@heroicons/react/outline";
...
const RegisterForm = () => {
  ...
  const emailRegister = async () => {
    try {
      await createUserByEmail(registerData.email, registerData.password, registerData.displayName);
