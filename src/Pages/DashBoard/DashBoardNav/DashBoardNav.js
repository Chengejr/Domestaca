  ...
  const userLinks = [
    {
      ...
      icon: <PlusCircleIcon className="text-indigo-500" width="20" height="20" />,
    },
    {
      name: "My Bookings",
  ...
  const dataLinks = [
    {
      ...
      icon: <UserGroupIcon className="text-indigo-500" width="20" height="20" />,
    },
    {
        ...
        <div className="w-72 h-screen">
          <nav className="mt-10 px-6">
            <CustomLink to="/dashboard">
              <IdentificationIcon className="text-indigo-500" width="20" height="20" />
                ...
                <div>
                  ...
                  {dataLinks.map((link) => (
                    <CustomLink to={link.url} key={link.url}>
                      {link.icon}
                      <span className="mx-4 text-md font-normal">{link.name}</span>
                    </CustomLink>
                  ))}
                </div>
                <div>
              ...
              <div>
                ...
                <div>
                  ...
                  <CustomLink to="/dashboard/addadmin">
                    <ShieldCheckIcon className="text-indigo-500" width="20" height="20" />
                    <span className="mx-4 text-md font-normal">Change Address</span>
                  </CustomLink>
          ...
          <div className="absolute bottom-0 my-10">
            <CustomLink
              ...
              to="/dashboard"
            >
              <QuestionMarkCircleIcon width="20" height="20" className="h-5 w-5" />
